def decisiontree(windowsize,crossvalnum):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_decisiontree.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + ' _Decision Tree')
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_decisiontree.png')
	#plt.show()
