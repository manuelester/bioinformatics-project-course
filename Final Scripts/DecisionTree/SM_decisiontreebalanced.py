def decisiontree(windowsize,crossvalnum):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_SM_balanced_decisiontree.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + ' _SM_bala_DT')
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_SM_balanced_DecisionTree.png')
	#plt.show()


decisiontree(windowsize = 7, crossvalnum = 5)
decisiontree(windowsize = 9, crossvalnum = 5)
decisiontree(windowsize = 11, crossvalnum = 5)
decisiontree(windowsize = 13, crossvalnum = 5)
decisiontree(windowsize = 15, crossvalnum = 5)
decisiontree(windowsize = 17, crossvalnum = 5)
