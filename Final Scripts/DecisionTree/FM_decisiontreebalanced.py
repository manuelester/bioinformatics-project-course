def decisiontree(windowsize,crossvalnum):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_balanced_decisiontree.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + ' _balanced_DT')
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_balanced_DecisionTree.png')
	#plt.show()
