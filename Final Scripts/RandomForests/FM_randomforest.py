def randomforest(windowsize,crossvalnum):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_randomforest.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + '_randomforest')
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_randomforest.png')
	#plt.show()
