def randomforest(windowsize,crossvalnum):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_SM_balanced_randomforest.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + '_SM_bala_rf')
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_SM_balanced_randomforest.png')
	#plt.show()
