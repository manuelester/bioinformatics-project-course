def windowautomation(windowsize,crossvalnum,cvalue):
	...
	for i in range(0,len(windows_train)):
		lin_clf = svm.LinearSVC(C = cvalue, class_weight = 'balanced')
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '_balanced.txt', 'w+')
	...
	plt.title('windowsize: ' + str(win) + ' fold-validation: ' + str(cvnum) + ' F1: ' + str(F1) + ' cvalue: ' + str(cvalue))
	plt.colorbar()
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '_balanced.png')
	#plt.show()

#windowautomation(windowsize = 7, crossvalnum = 5)
windowautomation(windowsize = 7, crossvalnum = 5, cvalue = 1)
windowautomation(windowsize = 9, crossvalnum = 5, cvalue = 1)
#windowautomation(windowsize = 9, crossvalnum = 5, cvalue = 10)
#windowautomation(windowsize = 9, crossvalnum = 5, cvalue = 100)
windowautomation(windowsize = 11, crossvalnum = 5, cvalue = 1)
#windowautomation(windowsize = 11, crossvalnum = 5, cvalue = 10)
#windowautomation(windowsize = 11, crossvalnum = 5, cvalue = 100)
windowautomation(windowsize = 13, crossvalnum = 5, cvalue = 1)
#windowautomation(windowsize = 13, crossvalnum = 5, cvalue = 10)
#windowautomation(windowsize = 13, crossvalnum = 5, cvalue = 100)
