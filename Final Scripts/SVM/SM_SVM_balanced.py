def windowautomation(windowsize,crossvalnum,cvalue):
	...
	printfile = open('SM_windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '_balanced.txt', 'w+')
	...
	plt.savefig('SM_windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '_balanced.png')
	#plt.show()
