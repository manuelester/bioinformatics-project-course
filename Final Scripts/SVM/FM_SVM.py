def windowautomation(windowsize,crossvalnum,cvalue):
	...
	printfile = open('windowsize_' + str(win) + '_fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '.txt', 'w+')
	...
	plt.savefig('windowsize_' + str(win) + 'fold_validation_' + str(cvnum) + '_cvalue_' + str(cvalue) + '.png')
	#plt.show()
